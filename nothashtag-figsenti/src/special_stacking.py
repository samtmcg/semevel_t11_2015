...
with open(label_file) as lf:
	for line in lf:
		...
		if not this_lab.lower() == 'nolabel':
			...
			#print 'this_lab ',this_lab, 'tweet_id ',tweet_id
...
with open(ensemble_file) as sf: # ERROR WAS HERE previously: with open(gen_sent_file) as sf
	for line in sf:
		line=line.strip()
		line = line.split('\t')
...
for ti in all_tweet_ids:
	...
	#print tweet_lab_dict[ti]+ '\t' + ti +'\t' + str(score)
	print ti +'\t' + str(score)
#print 'number gen sent scores: ', number_gensent
#print 'number ensemble scores: ', number_stacked
