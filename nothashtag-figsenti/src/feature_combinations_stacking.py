...
for L in range(1,number_outputs+1):
	...
	for x,y  in zip(training_combinations,testing_combinations):
		...
		linearregr_stacking_commands        = ['python','stacking.py','../data/zvals/tmp/','../data/twokenized/train.dat','-testScore','../data/twokenized/trial.dat','-model','linearregr']
		randomforrestregr_stacking_commands = ['python','stacking.py','../data/zvals/tmp/','../data/twokenized/train.dat','-testScore','../data/twokenized/trial.dat','-model','randomforrestregr']
		bayesianridge_stacking_commands     = ['python','stacking.py','../data/zvals/tmp/','../data/twokenized/train.dat','-testScore','../data/twokenized/trial.dat','-model', 'bayesianridge']
		ridgecv_stacking_commands           = ['python','stacking.py','../data/zvals/tmp/','../data/twokenized/train.dat','-testScore','../data/twokenized/trial.dat','-model', 'ridgecv']
